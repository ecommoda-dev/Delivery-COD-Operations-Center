...
// ⚠️ **الفاضي بياخد اسمه بالنص في الفلتر** — `—` سادة جوّه قايمة منسدلة
//    بتتقري **بند فاضي**، مش «الصفوف اللي محدش سجّل مكانها».
const WA_NONE = '— مش مسجّل';
...
function waFilterLabel(v) {
  ...
  return v === 'Office' ? '✅ في المكتب' : `⚠ ${waText(v)}`;
}
...
#    «السجل ناقص».
CL_READY   = r'''          <li class="cl-item"><span class="cl-tag new">جديد</span><span>🔴 <b>تاب «جرد المكتب» بقى له فلاتره هو</b> — خطوة ① فوق مربع السكان: <b>المندوب</b> (مناديب · بوسطة · شو روم) و<b>موقع الشحنة</b>. النطاق بقى <b>مستقل تمامًا</b> عن أي فلتر في تاب «الأوردرات»، والفلاتر <b>بتتقفل</b> مع «بدء الجرد» (النطاق لقطة) وبتتفك مع «جرد جديد».</span></li>
          <li class="cl-item"><span class="cl-tag change">تعديل</span><span>🔴 <b>قايمة فلتر «موقع الشحنة» بقت بنص البادج بالحرف</b> — <b>✅ في المكتب</b> · <b>⚠ المخزن</b> · <b>⚠ مع المندوب</b> بدل <code>Office</code>/<code>Warehouse</code>/<code>Courier</code>. الموظف كان بيدوّر في القايمة على الكلمة اللي شايفها في الجدول ومايلقهاش. ⚠️ والفلترة نفسها لسه على <b>القيمة الخام</b>.</span></li>
          <li class="cl-item"><span class="cl-tag new">جديد</span><span>🔴 <b>فلتر «التغليف»</b> — قيمتان وبس: <b>تم التغليف</b> · <b>لم يتم التغليف</b>. قبل كده السؤال ده إجابته الوحيدة كانت <b>ترتيب</b> عمود تاريخ التغليف وقراءة الصفوف بالعين. ⚠️ ومصدره <code>packedAt</code> نفسه — نفس الحقل اللي العمود بيعرضه بالحرف.</span></li>
          <li class="cl-item"><span class="cl-tag change">تعديل</span><span>🔴 <b>مقاسات الأعمدة</b> — «العميل» اتصغّر ~<b>٣٥٪</b>، و<b>عمودا التاريخ بقوا بنفس العرض بالظبط</b> (كان «تاريخ التغليف» أوسع لأن نص بادج التأخير أطول)، والمساحة اللي اتوفّرت راحت لـ<b>«العنوان»</b> و<b>«ملحوظات»</b> — العمودان اللي بيتقروا فعلاً.</span></li>
          <li class="cl-item"><span class="cl-tag change">تعديل</span><span><b>تاب «الطابور» بقى «الأوردرات»</b> — يطابق اسم الكارت في الشاشة الرئيسية («أوردرات جاهزة للشحن»).</span></li>
'''

CL_SHIPPED = r'''          <li class="cl-item"><span class="cl-tag new">جديد</span><span>🔴 <b>فلتر «التغليف»</b> — قيمتان وبس: <b>تم التغليف</b> · <b>لم يتم التغليف</b>. قبل كده السؤال ده إجابته الوحيدة كانت <b>ترتيب</b> عمود تاريخ التغليف وقراءة الصفوف بالعين. ⚠️ ومصدره <code>packedAt</code> نفسه — نفس الحقل اللي العمود بيعرضه بالحرف.</span></li>
          <li class="cl-item"><span class="cl-tag change">تعديل</span><span>🔴 <b>مقاسات الأعمدة</b> — «العميل» اتصغّر ~<b>٣٥٪</b>، و<b>عمودا التاريخ بقوا بنفس العرض بالظبط</b> (كان «تاريخ التغليف» أوسع لأن نص بادج التأخير أطول)، والمساحة اللي اتوفّرت راحت لـ<b>«العنوان»</b> و<b>«ملحوظات»</b> — العمودان اللي بيتقروا فعلاً.</span></li>
          <li class="cl-item"><span class="cl-tag change">تعديل</span><span>⚠️ <b>وباقي تحديث v1.7.0 في «قسم الجاهز للشحن»</b> (فلاتر تاب الجرد · ليبلات «موقع الشحنة» · عمودا العنوان والملحوظات) — الطابور ده مالوش الأعمدة ولا التاب دي. والنسخة <b>واحدة للهب كله</b> (مصدر واحد · #24)، فالرقم بيترفع هنا كمان.</span></li>
...
__AUDIT_TABS__
  ...
  <div class="card count-box">
    ...
    <div class="cb-mid">
      ...
      <div class="cb-money" id="qMoney"></div>
    </div>
    <div class="cb-act">
      <div class="dco-fresh">
...
__ABOUT_COLS__
          ...
          <ul>
            ...
            <li>مربعات المندوب <b>بتعدّ من القايمة الكاملة</b> مش المفلترة — ضغطة عليها
                بتفلتر، وضغطة تانية بترجّع الكل.</li>
          </ul>
        </div>
      </details>
__AUDIT_ABOUT__
